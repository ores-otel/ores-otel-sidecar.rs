...
final class SidecarEnvValues {
  const SidecarEnvValues({required this.allowNonLoopback, required this.bind});
...
SidecarEnvValues loadFrom(String? Function(String key) lookup) {
  return SidecarEnvValues(
    ...
    bind: _nonEmpty(lookup('ORES_OTEL_SIDECAR_BIND')) ?? '127.0.0.1:9090',
  );
}
...
Map<String, String> loadEnvMap(
  ...
  final bind = pick(['ORES_OTEL_SIDECAR_BIND'], ['flags', 'env_shell', 'env_file'], shell, dotenv, flags, '127.0.0.1:9090');
  if (bind != null) out['ORES_OTEL_SIDECAR_BIND'] = bind;
  return out;
}
