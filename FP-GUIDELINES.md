...
check was introduced: **25 findings across 11 files
and 933 lines**. CI compares against that budget and fails only when a
...
|---|---:|---|---|---|
| `RS003` | 12 | error | typed errors | panic-based control flow (`unwrap`/`expect`/`panic!`) |
